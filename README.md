...
**Greetings App** is a web application which displays random greeting each time you refresh the page.
...
- **Used Rails for back-end**
- **Displays random greeting**
...
```sh
  git clone https://github.com/MAleemH/hello-rails-react.git
